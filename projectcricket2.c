...
{
	printf("\n------------------------------------------------------------");
printf("\n%s: %d/%d\t  %s    %d*(%d)\t\tovers : %d.%d",team1,sum1,wicket1,player1[p1-1],play1[p1-1],ball1[p1-1],(float)sum1/ball*6,ball/6,ball%6);
printf("\n          \t  %s    %d(%d)",player1[p2-1],play1[p2-1],ball1[p2-1],ball/6,ball%6);
printf("\n\nRunrate : %.2f\t\t\t\t\textras : %d",(float)sum1/ball*6,ball/6,ball%6,sum1-sum3);
printf("\n\n••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••");
}
  else
  {
...
{
	printf("\n------------------------------------------------------------");
printf("\n%s: %d/%d\t  %s    %d*(%d)\t \t\tovers : %d.%d",team2,sum2,wicket2,player2[p1-1],play2[p1-1],ball2[p1-1],(float)sum2/ball*6,ball/6,ball%6);
...
printf("\n%s: %d/%d\t  %s    %d(%d)\t\t\tovers : %d.%d",team2,sum2,wicket2,player2[p1-1],play2[p1-1],ball2[p1-1],(float)sum2/ball*6,ball/6,ball%6);
printf("\n          \t  %s    %d*(%d)",player2[p2-1],play2[p2-1],ball2[p2-1]);
printf("\n\nRunrate : %.2f\t\t\t\nRequired Runrate : %.2f\t\t\t\textras : %d",(float)sum2/ball*6,ball/6,ball%6,(float)(sum1-sum2)/((overs*6)-ball)*6,sum2-sum4);
